...
export function UsersPage() {
  ...
  async function updateRole(userId: string, roleName: (typeof roles)[number]) {
    ...
    try {
      ...
      setError(exception instanceof ApiError ? exception.message : "Unable to change role.");
    }
  }
  ...
  async function updateActive(user: User) {
    ...
    try {
      ...
      setError(exception instanceof ApiError ? exception.message : "Unable to change status.");
    }
  }
